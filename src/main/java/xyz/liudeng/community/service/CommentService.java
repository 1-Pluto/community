...
import xyz.liudeng.community.mapper.*;
...
public class CommentService {
    ...
    private void createNotify(Comment comment, Long receive, String notifierName, String outerTitle, NotificationTypeEnum notificationType,Long outerId){
        if(receive ==comment.getCommentator()){
            return;
        }
        ...
        notification.setStauts(NotificationStautsEnum.UNREAD.getStauts());
